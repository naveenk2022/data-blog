...
Connect to your database with the database management tool of your choice. [I use DBeaver.](https://dbeaver.io/)

The Entity Relationship Diagram for the `public` schema of your database should look like this.

{{< figure
    src="basic_data_model_erd.png"
    caption="Our newly created data model!"
    align=center
>}}
...
- [SQLAlchemy documentation](https://docs.sqlalchemy.org/en/20/intro.html), most notably the [SQLAlchemy Unified Tutorial Section.](https://docs.sqlalchemy.org/en/20/tutorial/index.html#unified-tutorial)

- [Alembic's documentation](https://alembic.sqlalchemy.org/en/latest/index.html), and importantly, the [section covering Autogeneration.](https://alembic.sqlalchemy.org/en/latest/autogenerate.html)